...
2. Edit `docs/index.qmd` to add links for new decks; render the index:
...
- Path: `Images/...` (junction to repo `Images/` via `scripts/ensure_local_images.py` on pre-render; same files as `Slides_bilingual_fr_en/`)
